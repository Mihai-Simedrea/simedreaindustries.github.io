    ...
    >
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.background = 'rgba(10,61,51,0.13)')
          }
          onMouseLeave={(e) =>
            (e.currentTarget.style.background = 'rgba(10,61,51,0.07)')
          }
        >
          ×
        </button>
        ...
        >
          Trimite-ne un email cu detalii despre restaurantul tău și vom
          construi un demo personalizat în 48 de ore.
        </p>
